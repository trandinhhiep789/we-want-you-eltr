...
// get user by viTriUngTuyen 
router.get("/tuyendung/get_user_with_viTriUngTuyen", function (req, res, next) {
  // criteria tiêu chuẩn
  let criteria = {
    viTriUngTuyen: new RegExp(req.query.viTriUngTuyen, "i"), // <=> giống %abc% trong sql
  };
  const limit = parseInt(req.query.limit) > 0 ? parseInt(req.query.limit) : 100;
